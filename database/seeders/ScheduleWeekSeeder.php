        ...
        foreach ($weeks as $week) {
            foreach ($schedules as $schedule) {
                ...
                $data[] = [
                    ...
                    'is_online' => false,
                    'status' => 'closed',
                    'opened_at' => $dateForWeek->format('Y-m-d') < Carbon::now()->toDateString() ? $schedule->start_time : null,
                    'closed_at' => $dateForWeek->format('Y-m-d') < Carbon::now()->toDateString() ? $schedule->end_time : null,
                    'week_id' => $week->id,
