...
<body class="font-sans antialiased bg-[#ffff]">
    ...
    <nav class="bg-[#f9f9f9] border-gray-200 z-50 fixed top-0 left-0 w-full shadow">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 md:p-0">
            ...
            <button data-collapse-toggle="navbar-menu" type="button"
                class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-neutral-black rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
    ...
    <section id="product" class=" h-screen bg-yellow-50 w-full md:px-[60px] px-[20px] py-[80px] justify-items-center ">
    </section>
    ...
    <section id="team" class="bg-white h-screen flex items-center justify-center">
        <h1 class="text-4xl">Contact Section</h1>
    </section>
